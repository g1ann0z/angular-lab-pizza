...
export class PiattoDetailComponent {
  ...
  constructor(activatedRoute: ActivatedRoute) {
    /*const piattoId = +activatedRoute.snapshot.params['piattoId']; //+ cerca di convertire il paramentro in number (essendo un numero) anzichè restituirlo come string visto che il contenuto della variabile è una stringa

    this.piatto = this.menu.find(x => x.id === piattoId);*/

    const piattoId = activatedRoute.snapshot.params['piattoId']; //alternativa con backtick al posto del +, migliore e più sicura
